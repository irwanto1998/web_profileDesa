<head>
  ...
  <title>Desa Ampera Raya</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="/ass/img/logo.png" rel="icon">
  ...
  * License: https://bootstrapmade.com/license/
  ======================================================== -->
  <style>
    /* Contoh gaya kustom untuk tampilan paginasi */
        .blog-pagination1 {
            text-align: center;
        }

        .blog-pagination1 .pagination {
            display: inline-flex;
            padding: 0;
            margin: 0;
        }

        .blog-pagination1 .page-item {
            margin: 0 5px;
        }
  </style>
</head>